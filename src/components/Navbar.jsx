...
const Navbar = () => {
  return (
    <nav className="bg-gray-950 sticky top-0 z-50 backdrop-blur-sm bg-opacity-95">
            ...
            {/* <div className="flex items-center justify-center w-10 h-10 bg-gradient-to-r from-green-400 to-cyan-400 rounded-lg">
              <svg className="w-6 h-6 text-gray-900" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 10.99h7c-.53 4.12-3.28 7.79-7 8.94V12H5V6.3l7-3.11V12z"/>
                        ...
                        <div className="pl-6 h-12 flex items-center justify-center">
  <Shield className="w-6 h-6 text-green-400" />
          ...
          {/* <div className="hidden md:flex">
            <button className="bg-gradient-to-r from-emerald-600/60 to-cyan-600/60 hover:from-green-900/20 hover:to-cyan-900/20 hover:text-white px-6 py-2 rounded-lg text-sm font-medium transition-all duration-200 shadow-lg">
              Join Club
            </button>
          </div> */}
