        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/about"
                className="cursor-hover group relative bg-transparent hover:bg-green-500/10 text-green-400 hover:text-white px-8 py-4 text-base font-semibold rounded-full transition-all duration-300 border-2 border-green-500/30 hover:border-green-400 hover:scale-105 text-center"
              >
              ...
              <a
                ...
                className="cursor-pointer group relative bg-gradient-to-r from-green-500/20 to-cyan-500/20 hover:from-green-500 hover:to-cyan-500 text-white px-8 py-4 text-base font-semibold rounded-full transition-all duration-300 border-2 border-green-500/50 hover:border-transparent hover:scale-105 text-center"
              >
                <span className="relative z-10 flex items-center justify-center gap-2">
                  Join Our Team
